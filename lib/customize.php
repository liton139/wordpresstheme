...
function _themename_customize_register( $wp_customize) {
    ...
    /**####################################### SINGLE  SETTINGS ####################################################### */
    $wp_customize->add_section('_themename_single_options', array(
    ...
    $wp_customize->add_control('_themename_display_author_info', array(
        ...
        'section' => '_themename_single_options' 
    ));
    ...
    $wp_customize-> add_section('_themename_footer_options',array(
        ...
        'description' => esc_html__('you can change footer option from here.', '_themename'),
        'priority' => 30
    ));
