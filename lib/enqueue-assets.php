...
function _themename_assets(){
    ...
    '/dist/assets/js/bundle.js', array('jquery'),'1.0.0', true);
...
function _themename_block_editor_assets(){
    wp_enqueue_style('_themename-block-editor-styles', get_template_directory_uri() . 
    '/dist/assets/css/editor.css', array(), '1.0.0','all');
}
