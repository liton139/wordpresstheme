    ...
    ?>
        ...
        <p>
            ...
            <select name="_themename_post_layout_field" id="_themename_post_layout_field" class="widefat">
                ...
                <option <?php selected( $layout, 'sidebar' );?>  value="sidebar"><?php esc_html_e('Post Width Sidebar', '_themename');?></option>
            </select>
        </p>
    <?php
}
...
function _themename_save_post_metabox($post_id, $post) {
    ...
    if(!isset($_POST['_themename_update_post_nonce']) || !wp_verify_nonce( $_POST
    ['_themename_update_post_nonce'],'_themename_update_post_metabox' )) {
        return;
    }
